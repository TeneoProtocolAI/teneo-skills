...
name: linkedin-teneo
version: 2.0.64
description: "AI agent for LinkedIn via Teneo Protocol. Use this skill when the user needs LinkedIn via the bundled Teneo CLI and you need the live commands, arguments, or pricing before execution."
---
